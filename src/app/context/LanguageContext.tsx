...
const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    'artists.filterAll': 'الكل',
    'artists.filterMale': 'ذكر',
    'artists.filterFemale': 'أنثى',
    'artists.noResults': 'لا توجد نتائج',
    'artists.loadMore': 'عرض المزيد',
  ...
  en: {
    ...
    'artists.filterMale': 'Male',
    'artists.filterFemale': 'Female',
    'artists.noResults': 'No results found',
    'artists.loadMore': 'Load More',
