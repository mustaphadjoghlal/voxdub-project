...
const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    'hero.title1': 'اجعل لمشروعك',
    'hero.title2': 'صوتاً لا يُنسى',
  ...
  en: {
    ...
    'hero.title1': 'Give Your Project',
    'hero.title2': 'an Unforgettable Voice',
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  const setLang = (l: Lang) => {
    setLangState(l); try { localStorage.setItem('voxdub-lang', l) } catch {}; applyLang(l)
  }
