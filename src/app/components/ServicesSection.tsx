    ...
    },
    {
      icon: (
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
          ...
          <line x1="24" y1="18" x2="24" y2="22" stroke={color} strokeWidth="2" strokeLinecap="round"/>
        </svg>
      ),
    ...
    <section style={{ padding: '80px 24px', background: '#f8fafc' }} id="services">
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 56 }}>
          <h2 style={{ fontSize: 36, fontWeight: 900, color: '#111827', marginBottom: 12 }}>
            {t('services.title')}
          </h2>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 32 }}>
          {services.map((svc, i) => (
            ...
            >
              ...
              <h3 style={{ fontSize: 22, fontWeight: 800, color: '#111827', marginBottom: 12 }}>
                {t(svc.titleKey)}
              </h3>
